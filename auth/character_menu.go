...
func (lch *ListCharactersHandler) showCharacterMenu(s *database.Socket) ([]byte, error) {
	...
	sort.Slice(characters, func(i, j int) bool {
		date1, _ := time.Parse("2006-01-02 15:04:05", characters[i].CreatedAt)
		date2, _ := time.Parse("2006-01-02 15:04:05", characters[j].CreatedAt)
		return date1.Sub(date2) < 0
	})
