...
func FindUserByName(name string) (*User, error) {
	...
	var user User
	err := pgsql_DbMap.SelectOne(&user, "select * from hops.account where user_name = $1", name)
	if err != nil {
		return nil, err
	}
...
func FindUserByID(id string) (*User, error) {
	...
	var user User
	err := pgsql_DbMap.SelectOne(&user, "select * from hops.account where id = $1", id)
	if err != nil {
		return nil, err
	}
...
func FindUserByIP(ip string) (*User, error) {
	...
	var user User
	err := pgsql_DbMap.SelectOne(&user, "select * from hops.account where ip = $1", ip)
	if err != nil {
		return nil, err
	}
...
func FindUserByMail(mail string) (*User, error) {
	...
	var user User
	err := pgsql_DbMap.SelectOne(&user, "select * from hops.account where email = $1", mail)
	if err != nil {
		return nil, err
	}
