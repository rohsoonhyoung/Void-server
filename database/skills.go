...
var (
	...
	miningSkills = []int{41004, 41104, 41204, 41304, 41404, 41504, 41604, 41704, 90076, 90066, 90055, 90045, 90038, 90029, 90018, 90008}

	SkillPTS = map[string]map[int]int{
		"fjp": {0: 1, 1: 1, 2: 1, 3: 2, 4: 3, 5: 4, 6: 6, 7: 9, 8: 14, 9: 21, 10: 31, 11: 47, 12: 53, 13: 69, 14: 78, 15: 90, 16: 100, 17: 100, 18: 100, 19: 100, 20: 100},
		"wd":  {0: 3, 1: 2, 2: 3, 3: 4, 4: 6, 5: 9, 6: 14, 7: 21, 8: 31, 9: 47, 10: 70, 11: 105},
		"sjp": {
...
func (e *Skills) Delete() error {
	if e == nil {
		err := fmt.Errorf("Delete skills: skills is nil")
		return err
...
func FindSkillsByID(id int) (*Skills, error) {
	...
	skills := &Skills{}
	if err := pgsql_DbMap.SelectOne(&skills, query, id); err != nil {
...
func (s *Skills) GetSkillsData() ([]byte, error) {
	...
	for i, slot := range skillSlots.Slots {
		...
		} else if slot.BookID >= 100031005 && slot.BookID <= 100031072 {
