...
var (
	...
	/*
		pkgTypes2 = map[byte]Factory{
				...
				68: &player.DealDamageHandler{},
				69: &player.InstantAttackHandler{},
				//115:
				//175:
	...
	pkgTypes2 = map[byte]Factory{
		...
		//56:  &auth.LauncherHandler{},
		//16:  &auth.LauncherHandler{},
